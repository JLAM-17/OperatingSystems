...
public class OS {
    ...
    public void interrupt(InterruptType t, Process p) {
        ...
        switch (t) {
            ...
            case CPU: // It is assumed that the process in CPU is done and it has been removed from
                      // the cpu
            ...
            case IO: // It is assumed that the process in IO is done and it has been removed from the
                     // queue
                rq.addProcess(p);
                break;
